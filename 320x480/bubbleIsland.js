...
"King-Bear of the Paradise" hit rank 1 globally
	*/
	...
	this.archivements.tough1.title = "Really Tough Bear!";
	this.archivements.tough1.hint = "Hit level 20 without any booster (only for real bears)";
	this.archivements.combo1 = new this.archivement();
	this.archivements.combo1.title = "Master of the Combination! (Yeah!)";
	this.archivements.combo1.hint = "Made 5 'MegaCombo' combo in one level";
	this.archivements.combo2 = new this.archivement();
	this.archivements.combo2.title = "The Paradise is on Fire!";
	this.archivements.combo2.hint = "Made 5 'OnFire' combo in one level";
	this.archivements.cleaner = new this.archivement();
	this.archivements.cleaner.title = "Call Mr Plow, That's my name, That name again is Mr Plow";
	...
	this.archivements.king.hint = "Hit number 1 in the global ranking (that's a piece of cake!)";
	...
	this.serialize = function(){
		var result = {};
		result.archivements = {};
		result.archivements.tough1 = this.archivements.tough1.done;
		result.archivements.tough2 = this.archivements.tough2.done;
		result.archivements.combo1 = this.archivements.combo1.done;
		result.archivements.combo2 = this.archivements.combo2.done;
		result.archivements.cleaner = this.archivements.cleaner.done;
		result.archivements.king = this.archivements.king.done;
	...
	this.unserialize = function(result){
		this.archivements.tough1.done = result.archivements.tough1;
		this.archivements.tough2.done = result.archivements.tough2;
		this.archivements.combo1.done = result.archivements.combo1;
		this.archivements.combo2.done = result.archivements.combo2;
		this.archivements.cleaner.done = result.archivements.cleaner;
		this.archivements.king.done = result.archivements.king;
...
function gameUI(w, h){
	...
	this.lvlFrame.setAttribute('class', 'homelevel');
	this.rankFrame.setAttribute('class', 'homerank');
	this.scoreFrame.setAttribute('class', 'homescore');
...
api.levels.serializeLevel = function(game){
	...
	if(game.level.lblnro == undefined){
		lvl.lvlnumber = 0;
	}else{
	...
	lvl.ui.innerCoinds = game.ui.innerCoins;
	
	lvl.ui.archivements = game.ui.serialize();
...
api.levels.unserializeLevel = function(){
	...
	game.ui.refresh();
	game.ui.unserialize(lvl.ui.archivements);
